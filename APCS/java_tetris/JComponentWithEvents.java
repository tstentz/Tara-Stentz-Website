                                             ...
                                             Runnable // for deferredDoStart
{
  ...
  public final void beep() { doBeep(); }
  public final void exit() { doExit(); }
  public final int getTimerDelay()         { return _timerDelay; }
  public final void setTimerDelay(int delay){ doSetTimerDelay(delay); }
  public final void stopTimer()             { doStopTimer(); }
  public final boolean isPaused()           { return _paused; }
  public final void setPaused(boolean paused) { _paused = paused; }
  public final char getPauseKey()           { return _pauseKey; }
  public final void setPauseKey(char c)     { _pauseKey = c; }
  public final char getUnpauseKey()         { return _unpauseKey; }
  public final void setUnpauseKey(char c)   { _unpauseKey = c; }
  public final void setIgnoreModifierKeys(boolean b) { ignoreModifierKeys = b; }
  public final void play(String location)   { doPlay(location, false); }
  public final void loop(String location)   { doPlay(location, true); }
  public final void stopSounds()            { doStopSounds(); }
  ...
  public final static void setLineThickness(Graphics page, int thickness) {
  ...
  public final static int getStringWidth(Graphics page, Font f, String s) {
  ...
  public final static int getStringHeight(Graphics page, Font f, String s) {
    // Find the size of string s in the font of the Graphics context "page"
    FontMetrics fm   = page.getFontMetrics(f);
    java.awt.geom.Rectangle2D rect = fm.getStringBounds(s, page);
  ...
  public final static int getStringAscent(Graphics page, Font f, String s) {
    // Find the size of string s in the font of the Graphics context "page"
    FontMetrics fm   = page.getFontMetrics(f);
    return fm.getAscent();
  }

  public final static void drawCenteredString(Graphics page, String s, int left, int top, int width, int height) {
  ...
  public final static boolean shapesIntersect(Shape s1, Shape s2) {
  ...
  public final BufferedImage loadBufferedImage(String filename) {
  ...
  public final void saveBufferedImage(BufferedImage image, String filename) {
  ...
  public final static synchronized JComponentWithEvents newInstance(Class c, int w, int h) {
  ...
  public final static void launch() {
    launch(500,400); // default size
  }

  public final static synchronized void launch(int width, int height) {
    try {
      Class c = null;
